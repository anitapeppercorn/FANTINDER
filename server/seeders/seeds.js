...
db.once('open', async () => {
 ...
 /*// create Movies
  ...
  for (let i = 0; i < 100; i += 1) {
    ...
    const movieImage = 'https://image.tmdb.org/t/p/w185_and_h278_bestv2/rplLJ2hPcOQmkFhTqUte0MkEaO2.jpg'
    //faker.image.imageUrl();
    const movieVote = 5
    //faker.random.number()*5;
    const movieName = "The Silence of the Lambs"
    ...
    //movieRelease, movieOverview, movieId, movieImage, movieVote, movieName, username
